...
ALTERNATIVES_V1 = Prompt(
    ...
    system=(
        ...
        "Assess each option on the dimensions given. Where the evidence cannot support an "
        "assessment, mark that dimension cannot_assess and say what is missing. Do not "
        "guess, and do not treat absence of evidence as evidence of low value — that "
        "systematically defunds anything new, because a bet has no track record by "
        "definition.\n\n"
